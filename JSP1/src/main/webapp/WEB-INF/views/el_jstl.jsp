<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"  %>
 <%--이 위의 지시자 태그 안에있는걸 작성해야 JSTL을 사용할수잇음 
...
<body>
	...
	<pre>
		<%-- 
	 	...
	 	(JSP 내부에 기본 내장되어 있음 !) 즉 다른거 다운로드받아서 참조 안해도댐 개꿀
	...
	주소 뒤에 쿼리스트링 (?name = 홍길동 &age = 20)
	 ...
	 <h4> 2. EL</h4>	
	 <%--
	 	EL 의 특징 : 1. null, NullPointException 은 다 빈칸으로 처리함. 
	  ...
	  --%>
	 	...
	 	<pre>
	 		...
	 		(if,for,변수선언 ...)
	 		스크립틀릿이 아닌 HTML 태그 모양으로 작성할 수있또록
	 		태그를 제공하는 라이브러리
	 		
	 		[라이브러리 추가 방법]
	 		1. 필요한 라이브러리(.jar) 파일을 다운받기
	 		2. 프로젝트 webapp/WEB-INF/lib 폴더에
	 			다운로드 받은 라이브러리 추가 (드래그앤 드랍, 복붙)
